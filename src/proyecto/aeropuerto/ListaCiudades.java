...
public class ListaCiudades {
    ...
    public void insertFinal(Ciudad info){
    ...
    public Ciudad obtainValue(int n){
    ...
    public void printList(){
        ...
        for (int i = 0; i < this.size; i++) {
            System.out.println(this.obtainValue(i).getNombre());
        }
    }
    ...
    public String toStringList(){
        ...
        for (int i = 0; i < this.size; i++) {
            if(i < this.size - 1){
                result+= this.obtainValue(i).getNombre() + " >> ";
            }
            else{
                result+= this.obtainValue(i).getNombre() + "\n";
            }
    ...
    public int getIndex(Ciudad elem){
        if(first == null){
            return -1;
        }
        else{
    ...
    public void removeElement(Ciudad elem){
        if(first != null){
            Nodo aux1 = first;
